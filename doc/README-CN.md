...
这里是 WorkspAIce 社区版的代码仓库，以 GPLv3 许可证开源。

[WorkspAIce 再次开源！](https://github.com/workspaiceai/workspaice/issues/2266)
...
<a href='https://workspaiceai.app/zh/install?download=android_apk' style='margin-right: 4px; display: inline-flex; justify-content: center'>
<img src='./statics/android.png' style="height:28px; display: inline-block" />
.APK
</a>

更多信息请访问: [workspaiceai.app](https://workspaiceai.app/)
...
<p align="center">
    <em>WorkspAIce 是一个 AI 模型桌面客户端，支持 ChatGPT、Claude、Google Gemini、Ollama 等主流模型，适用于 Windows、Mac、Linux、Web、Android 和 iOS 全平台</em>
</p>
...
<a href="https://github.com/workspaiceai/workspaice/releases" target="_blank">
<img alt="下载量" src="https://img.shields.io/github/downloads/workspaiceai/workspaice/total.svg?style=flat" />
</a>
...
[![星星历史图表](https://api.star-history.com/svg?repos=workspaiceai/workspaice&type=Date)](https://star-history.com/#workspaiceai/workspaice&Date)

## 联系方式

[Twitter](https://x.com/WorkspAIceAI_HQ) | [电子邮件](mailto:hi@workspaiceai.com)
